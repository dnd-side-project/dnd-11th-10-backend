...
public class LeaningController {
    ...
    public ResponseEntity<TestProblemResponse> findTestBy(@PathVariable Long id) {
        ...
        ProblemInfoResponse problem1 = new ProblemInfoResponse(1L, "아젠다 정리한 것 오늘까지 보내주세요.", "Agenda", "아젠다", "비즈니스", 70.1d, 29.9d, List.of(option1, option2, option3, option4));
        ...
        ProblemInfoResponse problem2 = new ProblemInfoResponse(7L, "퀴즈를 위해 목 데이터를 생성했습니다.", "Mock Data", "목 데이터", "개발", 29.9d, 70.1d, List.of(option5, option6, option7, option8));
        ...
        ProblemInfoResponse problem3 = new ProblemInfoResponse(10L, "이번 스프린트의 스크럼 회의를 내일 오전에 진행하도록 하겠습니다.", "Scrum", "스크럼", "비즈니스", 23.2d, 76.8d, List.of(option9, option10, option11, option12));
        ...
        ProblemInfoResponse problem4 = new ProblemInfoResponse(13L, "넛지를 활용해 사용자가 스크롤 다운할 수 있도록 유도해주세요.", "Nudge", "넛지", "디자인", 76.8d, 23.2d, List.of(option13, option14, option15, option16));
        ...
        ProblemInfoResponse problem5 = new ProblemInfoResponse(18L, "사용자가 정보를 쉽게 이해하고 해석할 수 있도록 가시화 기법을 사용해주세요.", "Visualization", "가시화", "디자인", 58.2d, 41.8d, List.of(option17, option18, option19, option20));
    ...
    public ResponseEntity<TestExplanationResponse> solveTest(@PathVariable Long id, @RequestBody SolveTestRequest request) {
        ...
        ExplanationInfoResponse explanation1 = new ExplanationInfoResponse(answers[0], requestAnswer.get(0).equals(answers[0]), requestAnswer.get(0).equals(answers[0]), "Agenda", "아젠다", options.get(requestAnswer.get(0)), options.get(answers[0]));
        ExplanationInfoResponse explanation2 = new ExplanationInfoResponse(answers[1], requestAnswer.get(1).equals(answers[1]), requestAnswer.get(1).equals(answers[1]), "Mock Data", "목 데이터", options.get(requestAnswer.get(1)), options.get(answers[1]));
        ExplanationInfoResponse explanation3 = new ExplanationInfoResponse(answers[2], requestAnswer.get(2).equals(answers[2]), requestAnswer.get(2).equals(answers[2]), "Scrum", "스크럼", options.get(requestAnswer.get(2)), options.get(answers[2]));
        ExplanationInfoResponse explanation4 = new ExplanationInfoResponse(answers[3], requestAnswer.get(3).equals(answers[3]), requestAnswer.get(3).equals(answers[3]),"Nudge", "넛지", options.get(requestAnswer.get(3)), options.get(answers[3]));
        ExplanationInfoResponse explanation5 = new ExplanationInfoResponse(answers[4], requestAnswer.get(4).equals(answers[4]), requestAnswer.get(4).equals(answers[4]),"Visualization", "가시화", options.get(requestAnswer.get(4)), options.get(answers[4]));
