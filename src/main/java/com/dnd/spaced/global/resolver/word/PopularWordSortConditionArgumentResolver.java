...
@Component
public class PopularWordSortConditionArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(SearchWordSortCondition.class) && parameter.getParameterType()
